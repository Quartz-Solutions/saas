    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-GETapi-v1-me">Show the current authenticated user.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="tenants">
                    <a href="#tenants">Tenants</a>
                                ...
                                <a href="#tenants-GETapi-v1-tenants">List tenants visible to the authenticated user.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="auth">Auth</h1>
                                ...
                                <h2 id="auth-GETapi-v1-me">Show the current authenticated user.</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="tenants">Tenants</h1>
                                ...
                                <h2 id="tenants-GETapi-v1-tenants">List tenants visible to the authenticated user.</h2>
