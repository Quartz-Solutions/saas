...
class CmsPageUpdateRequest extends AdminFormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            'slug' => [
                'nullable', 'string', 'alpha_dash', 'max:160',
                Rule::unique('cms_pages', 'slug')->ignore($pageId)->withoutTrashed(),
            ],
            'title' => ['required', 'string', 'max:240'],
            'locale' => ['required', 'string', 'max:8'],
            'parent_id' => ['nullable', 'integer', 'exists:cms_pages,id', "different:$pageId"],
