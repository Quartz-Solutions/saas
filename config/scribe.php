...
return [
    ...
    'laravel' => [
        ...
        // We host the marketing CMS at `/docs/{slug}` (loaded by routes/web.php
        // BEFORE the Scribe service provider). To avoid collision we expose the
        // API reference under `/api-docs`.
        'docs_url' => '/api-docs',
